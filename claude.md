...
- The tests folder contains everything you need to perform closed-loop testing by yourself:
  ...
  - a target archive into which documents can be sorted in tests/fixtures/archive
- You have a browser integration available to access the dashboard (access to the tool needs to be requested from me)
- Clean up after yourself: Undo any changes you did to the tests folder and kill processes that you started